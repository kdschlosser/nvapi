# Auto-generated from https://github.com/NVIDIA/nvapi/blob/main/nvapi_interface.h
# SPDX-FileCopyrightText: Copyright (c) NVIDIA CORPORATION & AFFILIATES. MIT License.
NVAPI_INTERFACE_IDS = {
