...
__d3d10sdklayers_h__ = None
__ID3D10Debug_FWD_DEFINED__ = None
__ID3D10SwitchToRef_FWD_DEFINED__ = None
__ID3D10InfoQueue_FWD_DEFINED__ = None
__ID3D10Debug_INTERFACE_DEFINED__ = None
__ID3D10SwitchToRef_INTERFACE_DEFINED__ = None
__ID3D10InfoQueue_INTERFACE_DEFINED__ = None

IID_ID3D10Debug = MIDL_INTERFACE(
            "{None        }"
        )


class ID3D10Debug(comtypes.IUnknown):
    _case_insensitive_ = True
    _idlflags_ = []
    _iid_ = IID_ID3D10Debug
...
if not defined(__d3d10sdklayers_h__):
    # Forward Declarations
    if not defined(__ID3D10Debug_FWD_DEFINED__):
    # END IF  __ID3D10Debug_FWD_DEFINED__

    if not defined(__ID3D10SwitchToRef_FWD_DEFINED__):
        class ID3D10SwitchToRef(comtypes.IUnknown):
            _case_insensitive_ = True
            _iid_ = None
            _idlflags_ = []

    # END IF  __ID3D10SwitchToRef_FWD_DEFINED__

    if not defined(__ID3D10InfoQueue_FWD_DEFINED__):
        class ID3D10InfoQueue(comtypes.IUnknown):
            _case_insensitive_ = True
            _iid_ = None
            _idlflags_ = []

    # END IF  __ID3D10InfoQueue_FWD_DEFINED__

    # header files for imported files
    from pyWinAPI.um.oaidl_h import * # NOQA
    from pyWinAPI.um.ocidl_h import * # NOQA
    from pyWinAPI.shared.dxgi_h import * # NOQA
    ...
    if WINAPI_FAMILY_PARTITION(WINAPI_PARTITION_DESKTOP):
        if not defined(__ID3D10Debug_INTERFACE_DEFINED__):
            ...
            if defined(__cplusplus) and not defined(CINTERFACE):
                ...
                ID3D10Debug._iid_ = IID_ID3D10Debug


                ID3D10Debug._methods_ = [
                    COMMETHOD(
        ...
        # END IF  __ID3D10Debug_INTERFACE_DEFINED__

        if not defined(__ID3D10SwitchToRef_INTERFACE_DEFINED__):
            # interface ID3D10SwitchToRef
            # [unique][local][object][uuid]
            if defined(__cplusplus) and not defined(CINTERFACE):
                pass
            else:
                IID_ID3D10SwitchToRef = MIDL_INTERFACE(
                    "{9B7E4E02-342C-4106-A19F-4F2704F689F0}"
                )
                ID3D10SwitchToRef._iid_ = IID_ID3D10SwitchToRef


                ID3D10SwitchToRef._methods_ = [
                    COMMETHOD(
            ...
            # END IF  C style interface
        # END IF  __ID3D10SwitchToRef_INTERFACE_DEFINED__

        # interface __MIDL_itf_d3d10sdklayers_0000_0002
        # [local]
        DXGI_DEBUG_D3D10 = DEFINE_GUID(
            0x243B4C52,
            0x3606,
            0x4D3A,
            0x99,
        ...
        class D3D10_MESSAGE_CATEGORY(ENUM):
            ...
            D3D10_MESSAGE_CATEGORY_CLEANUP = (
                D3D10_MESSAGE_CATEGORY_INITIALIZATION + 1
            )
            D3D10_MESSAGE_CATEGORY_COMPILATION = (
                D3D10_MESSAGE_CATEGORY_CLEANUP + 1
            )
            ...
            D3D10_MESSAGE_CATEGORY_SHADER = (
                D3D10_MESSAGE_CATEGORY_EXECUTION + 1
            )


        class D3D10_MESSAGE_SEVERITY(ENUM):
            D3D10_MESSAGE_SEVERITY_CORRUPTION = 0
            D3D10_MESSAGE_SEVERITY_ERROR = (
                D3D10_MESSAGE_SEVERITY_CORRUPTION + 1
            )
        ...
        class D3D10_MESSAGE_ID(ENUM):
            ...
            D3D10_MESSAGE_ID_CORRUPTED_PARAMETER1 = (
                D3D10_MESSAGE_ID_CORRUPTED_THIS + 1
            )
            ...
            D3D10_MESSAGE_ID_LIVE_BUFFER = (
                D3D10_MESSAGE_ID_LIVE_OBJECT_SUMMARY + 1
            )
            D3D10_MESSAGE_ID_LIVE_TEXTURE1D = D3D10_MESSAGE_ID_LIVE_BUFFER + 1
            D3D10_MESSAGE_ID_LIVE_TEXTURE2D = (
                D3D10_MESSAGE_ID_LIVE_TEXTURE1D + 1
            )
            D3D10_MESSAGE_ID_LIVE_TEXTURE3D = (
                D3D10_MESSAGE_ID_LIVE_TEXTURE2D + 1
            )
            D3D10_MESSAGE_ID_LIVE_SHADERRESOURCEVIEW = (
                D3D10_MESSAGE_ID_LIVE_TEXTURE3D + 1
            )
            D3D10_MESSAGE_ID_LIVE_RENDERTARGETVIEW = (
                D3D10_MESSAGE_ID_LIVE_SHADERRESOURCEVIEW + 1
            )
            D3D10_MESSAGE_ID_LIVE_DEPTHSTENCILVIEW = (
                D3D10_MESSAGE_ID_LIVE_RENDERTARGETVIEW + 1
            )
            D3D10_MESSAGE_ID_LIVE_VERTEXSHADER = (
                D3D10_MESSAGE_ID_LIVE_DEPTHSTENCILVIEW + 1
            )
            D3D10_MESSAGE_ID_LIVE_GEOMETRYSHADER = (
                D3D10_MESSAGE_ID_LIVE_VERTEXSHADER + 1
            )
            D3D10_MESSAGE_ID_LIVE_PIXELSHADER = (
                D3D10_MESSAGE_ID_LIVE_GEOMETRYSHADER + 1
            )
            D3D10_MESSAGE_ID_LIVE_INPUTLAYOUT = (
                D3D10_MESSAGE_ID_LIVE_PIXELSHADER + 1
            )
            D3D10_MESSAGE_ID_LIVE_SAMPLER = (
                D3D10_MESSAGE_ID_LIVE_INPUTLAYOUT + 1
            )
            D3D10_MESSAGE_ID_LIVE_BLENDSTATE = (
                D3D10_MESSAGE_ID_LIVE_SAMPLER + 1
            )
            D3D10_MESSAGE_ID_LIVE_DEPTHSTENCILSTATE = (
                D3D10_MESSAGE_ID_LIVE_BLENDSTATE + 1
            )
            D3D10_MESSAGE_ID_LIVE_RASTERIZERSTATE = (
                D3D10_MESSAGE_ID_LIVE_DEPTHSTENCILSTATE + 1
            )
            D3D10_MESSAGE_ID_LIVE_QUERY = (
                D3D10_MESSAGE_ID_LIVE_RASTERIZERSTATE + 1
            )
            ...
            D3D10_MESSAGE_ID_D3D10_MESSAGES_END = (
                D3D10_MESSAGE_ID_LIVE_SWAPCHAIN + 1
            )
        ...
        D3D10_INFO_QUEUE_FILTER_DESC._fields_ = [
            ('NumCategories', UINT),
            # [annotation]
            ('pCategoryList', POINTER(D3D10_MESSAGE_CATEGORY)),
            ('NumSeverities', UINT),
            # [annotation]
            ('pSeverityList', POINTER(D3D10_MESSAGE_SEVERITY)),
            ('NumIDs', UINT),
            # [annotation]
            ('pIDList', POINTER(D3D10_MESSAGE_ID)),
        ]
        ...
        if not defined(__ID3D10InfoQueue_INTERFACE_DEFINED__):
            # interface ID3D10InfoQueue
            # [unique][local][object][uuid]
            if defined(__cplusplus) and not defined(CINTERFACE):
                pass
            else:
                IID_ID3D10InfoQueue = MIDL_INTERFACE(
                    "{1B940B17-2642-4D1F-AB1F-B99BAD0C395F}"
                )
                ID3D10InfoQueue._iid_ = IID_ID3D10InfoQueue


                ID3D10InfoQueue._methods_ = [
                    COMMETHOD(
                    ...
                    COMMETHOD(
                        ...
                        (['out'], POINTER(D3D10_MESSAGE), 'pMessage'),
                        (
                            ['out', 'in'],
                            POINTER(SIZE_T),
                            'pMessageByteLength'
                    ...
                    COMMETHOD(
                        ...
                        (['in'], POINTER(D3D10_INFO_QUEUE_FILTER), 'pFilter'),
                    ),
                    COMMETHOD(
                        ...
                        (
                            ['out'],
                            POINTER(D3D10_INFO_QUEUE_FILTER),
                            'pFilter'
                        ),
    ...
    IID_ID3D10SwitchToRef = DEFINE_GUID(
        0x9B7E4E02,
        0x342C,
        0x4106,
        0xA1,
    ...
    IID_ID3D10InfoQueue = DEFINE_GUID(
        0x1B940B17,
        0x2642,
        0x4D1F,
        0xAB,
